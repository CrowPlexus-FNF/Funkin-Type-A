...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Funkin-TypeA", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Funkin-TypeA", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "4";
		app.meta["company"] = "CrowPlexus";
		app.meta["file"] = "Funkin-TypeA";
		app.meta["name"] = "Friday Night Funkin': Type A";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: true,
			title: "Friday Night Funkin': Type A",
			width: 1280,
			x: null,
			y: null,
		};
		...
		#elseif air
		app.window.title = "Friday Night Funkin': Type A";
		#else
